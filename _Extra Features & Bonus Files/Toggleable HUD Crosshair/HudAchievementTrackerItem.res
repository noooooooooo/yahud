...
/////////////////////////////////////////////////////////////////////////////
	...
	//set an all-class achievement in-game to be tracked to enable the achievement tracker.
	
	//adjust the crosshair if needed (xpos, ypos, tall, wide)
	
	//use hud_achievement_tracker "1" to toggle the crosshair on (1) or off (0)
